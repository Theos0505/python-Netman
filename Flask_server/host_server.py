...
def hosts():
    global global_hosts  # Do not do this in flask !!!!!
...
def devices():
    global global_devices  # Do not do this in flask !!!!!
...
def services():
    global global_services  # Do not do this in flask !!!!!
...
# This section not in the OG code
